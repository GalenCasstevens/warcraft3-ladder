								...
								<Col>
									<Row className="profile-breakdown-header-progress-bar">
										...
										<div className="level-container">
											<ProgressBar className="profile-progress-bar" now={50} />
											<span className="level-num align-middle">Level {90}</span>
										</div>
							...
							<Row className="profile-breakdown-main-row">
								<Col>
									<Row className="profile-breakdown-header-progress-bar">
										...
										<div className="level-container">
											<ProgressBar className="profile-progress-bar" now={50} />
											<span className="level-num align-middle">Level {44}</span>
										</div>
										<Row className="level-indicators">
											<Col xs={4}>
												<div className="float-start">
